...
namespace LunarLander.Screens
{
    class WinScreen : GameScreen
    {
        ...
        public override void Update(GameTime gameTime, StateManager screen, GamePadState gamePadState, MouseState mouseState, KeyboardState keyboardState, InputHandler input)
        {
            ...
            if (input.WasPressed(0, InputHandler.ButtonType.B, Keys.M))
            {
        ...
        {
            LinkedList<Vector2> screenTitle = MyFont.GetWord(GlobalValues.TitleFontScaleSize, "You Win");
            ...
            Vector2 screenTitlePos = new Vector2(GlobalValues.GetWordCenterPos("You Win", true).X, 100);
            ...
            {
                pb.AddVertex(v2 + screenTitlePos, Color.Green);
            }
