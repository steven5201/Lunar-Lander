...
{
    class ChangeDifficultyScreen : GameScreen
    {
        PrimitiveBatch pb;
        ...
        {
            LinkedList<Vector2> screenTitle = MyFont.GetWord(GlobalValues.TitleFontScaleSize, "Difficulty");
            LinkedList<Vector2> notImplemented = MyFont.GetWord(GlobalValues.FontScaleSize, "Not implemented");

            Vector2 screenTitlePos = new Vector2(GlobalValues.GetWordCenterPos("Difficulty", true).X, 100);
